...
const TextStyle _lyricStyle = TextStyle(color: Colors.grey, fontSize: 14);
const TextStyle _remarkStyle = TextStyle(color: Colors.grey, fontSize: 14);
const TextStyle _currLyricStyle = TextStyle(color: Colors.black, fontSize: 14);
const TextStyle _currRemarkLyricStyle =
    TextStyle(color: Colors.red, fontSize: 14);
const List<Lyric> _remarkLyrics = [];
...
class LyricWidget extends StatefulWidget {
  ...
  //字体最大宽度
  double lyricMaxWidth = 15;

  LyricWidget(
      {Key? key,
      required this.lyrics,
      this.remarkLyrics=_remarkLyrics,
      this.controller,
      this.size = Size.zero,
      this.lyricStyle = _remarkStyle,
      this.remarkStyle = _remarkStyle,
      this.currLyricStyle = _remarkStyle,
      this.lyricGap: 10,
      this.remarkLyricGap: 20,
      this.draggingLyricStyle = _remarkStyle,
      this.draggingRemarkLyricStyle = _remarkStyle,
      this.enableDrag: true,
      this.lyricMaxWidth = 15,
      this.currRemarkLyricStyle = _remarkStyle}) {
    //歌词转画笔
...
class _LyricWidgetState extends State<LyricWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: CustomPaint(painter: _lyricPainter, size: widget.size),
    );
  }
}

// class _LxyricWidgetState extends State<LyricWidget> {
//   late LyricPainter _lyricPainter;
